...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryColor = const Color(0xFFCACACA);
  late Color tertiaryColor = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFCACACA);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF504E4E);
